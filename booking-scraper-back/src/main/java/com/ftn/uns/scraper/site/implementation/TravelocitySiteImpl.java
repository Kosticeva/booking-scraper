...
public class TravelocitySiteImpl implements Site{
    ...
    public Iterable<Result> scrapePage(HtmlPage page) {
        try {
            @Cleanup BufferedWriter log = new BufferedWriter(new FileWriter(new File("src/main/resources/site-htmls/travelocity.html")));
    ...
    public String createSearchQueryURL(String location, String checkIn, String checkOut, String rooms, String adults,
                                       String children) {
        String QUERY_ADDRESS = "https://www.travelocity.com/Hotel-Search";
